                    ...
                    <div key={item.id} className="group">
                      <div className="flex gap-3 p-3 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">${item.price.toFixed(2)} each</p>
          ...
          {items.length > 0 && (
            <div className="border-t bg-gray-50 dark:bg-gray-800/50">
              ...
              <div className="p-4 space-y-3">
                ...
                {shipping > 0 && <p className="text-xs text-gray-500 text-center">Free shipping on orders over $100</p>}
